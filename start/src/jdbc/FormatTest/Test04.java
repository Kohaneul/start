...
public class Test04 {
	...
	public Test04() {
		/*
		 	...
		 	INSERT INTO emp VALUES(1235,'로제','rose',....)
		 	INSERT INTO emp VALUES(1236,'리사','lisa',....)
		 ...
		 */
		/*
		 	list에서 변화하는 데이터만 추출하고 싶다 : MessageFormat에서 데이터가 들어갈 부분을 명시한 패턴을 만들고 
		 	parse 함수를 이용해서 데이터 부분을 추출하면 된다.
		 */
