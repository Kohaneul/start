...
public class Ex03 {
	...
	public Ex03() {
		...
		Student s1 = new Student(setName(sc),setRnd(60,100),setRnd(60,100),setRnd(60,100));
		s1.setBan(1);
		System.out.print("두번째 학생 이름 입력 : ");
		Student s2 = new Student(setName(sc),setRnd(60,100),setRnd(60,100),setRnd(60,100));
		s2.setBan(1);
