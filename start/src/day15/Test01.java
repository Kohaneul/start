...
/*
 	파라미터로 전달된 문자열
 		http://www.blackpink.org/member/@id=euns&pw=12345&tel=@01024469011
 		중에서 넘겨진 데이터만 갈라서 출력하세요.
 */
...
public class Test01 {
	...
	public Test01() {
		String url = "http://www.blackpink.org/member/?id=euns&pw=12345&tel=@01024469011";
		// 위의 문자열에서 데이터부분만 추출하려면 
		// ? 기호의 위치값을 알아낸 후 그 바로 다음 위치에서부터 끝까지 잘라내면 된다.
		int idx = url.indexOf("?");
		String param = url.substring(idx+1);	// => id=euns&pw=12345&tel=@01024469011
		...
		/*
		 	반복문에서 조건식의 의미는 반복횟수의 컨트롤에 의미가 있다.
		 */
